...
public class RulePanel extends JPanel
{
	...
	public RulePanel(HashMap brick_images, IntStringMap mark_array, IntStringMap state_array, int id, RuleTreePanel parent_panel)
    {
		//super();
        ...
        id_=id;
        selected_=true;
        acition_panel_ = new ActionPanel(brick_images_,mark_array, state_array, this, id_);
        condition_panel_ = new ConditionPanel(brick_images_, mark_array, state_array, this, id_);
        initComponents();
	}

	public RulePanel(HashMap brick_images, IntStringMap mark_array, IntStringMap state_array, Instruction instruction, int id, RuleTreePanel parent_panel)
    {
		//super();
		parent_panel_=parent_panel;
        brick_images_ = brick_images;
        ...
        acition_panel_ = new ActionPanel(brick_images_, mark_array, state_array, instruction.getAction(), this, id_);
        condition_panel_ = new ConditionPanel(brick_images_, mark_array, state_array, instruction.getCondition(), this, id_);
        initComponents();
	}
	...
	private void initComponents()
	{
        ...
        active_switch_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                {
                    selected_=true;
                 	SqlCommunicator.add_log("Regel aktiviert. Regel id: " + Integer.toString(id_), 256);
             	}
                else
                {
	                SqlCommunicator.add_log("Regel deaktiviert. Regel id: " + Integer.toString(id_), 256);
                    selected_=false;
            	}
                changedSelected();
            }
        ...
        delete_button_.addActionListener(new java.awt.event.ActionListener()
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
            	SqlCommunicator.add_log("Regel entfernt. Regel id: " + Integer.toString(id_), 256);
	...
	{
	  return new Instruction (condition_panel_.getCondition(), acition_panel_.getAction(), id_, selected_);
	}
