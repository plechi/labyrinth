...
public class RobotEnviromentSensorPanel extends JPanel
{
    ...
    public RobotEnviromentSensorPanel(HashMap brick_images, UpdateObject parent_panel) 
    {
        super();
    ...
    public RobotEnviromentSensorPanel(HashMap brick_images, UpdateObject parent_panel, String name) 
    {
        super();
        brick_images_ = brick_images;
        parent_panel_=parent_panel;
    ...
    public RobotEnviromentSensorPanel(HashMap brick_images, int init_state, UpdateObject parent_panel) 
    {
        super();
        brick_images_ = brick_images;
        parent_panel_=parent_panel;
    ...
    public RobotEnviromentSensorPanel(HashMap brick_images, int init_state, UpdateObject parent_panel, String name) 
    {
        super();
        brick_images_ = brick_images;
        parent_panel_=parent_panel;
