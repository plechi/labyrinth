...
public class BrickImages {
    ...
    private HashMap<String, Object> brick_images_;
    private String image_folder_;
    private final URL code_base_;
    ...
    private ImageIcon loadIcon(String name) {
        ...
        ClassLoader loader = BrickImages.class.getClassLoader();
        URL url = loader.getResource(image_folder_ + "/" + name);
     ...
     * 
     * @return HashMap of brick images
     */
    public HashMap<String, Object> loadImages() {
