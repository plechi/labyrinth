...
public class RobotDirectionPanel extends JPanel 
{
    ...
    public RobotDirectionPanel(HashMap brick_images, UpdateObject parent_panel, String name) 
    {
        super();
        brick_images_ = brick_images;
        parent_panel_=parent_panel;
    ...
    public RobotDirectionPanel(HashMap brick_images, int init_state, UpdateObject parent_panel) 
    {
        super();
        brick_images_ = brick_images;
        parent_panel_=parent_panel;
    ...
    public RobotDirectionPanel(HashMap brick_images, int init_state, UpdateObject parent_panel, String name) 
    {
        super();
        brick_images_ = brick_images;
        parent_panel_=parent_panel;
    ...
    private void initMouseListener() 
    {
        this.addMouseListener(new java.awt.event.MouseAdapter() 
        {
            public void mouseClicked(java.awt.event.MouseEvent evt) 
            {
                ...
                if(name_!=null)
	            {
		            SqlCommunicator.add_log(name_+" geändert zu "+direction, 512);
		        }
		        else
		        {
			        SqlCommunicator.add_log("Richtung geändert zu "+direction, 512);
			    }
                paintState();
