...
public class ConditionPanel extends JPanel implements UpdateObject {
    ...
    public ConditionPanel(HashMap brick_images, IntStringMap mark_array,
            IntStringMap state_array, RulePanel parent_panel, int id) {
        super();
        brick_images_ = brick_images;
        parent_panel_ = parent_panel;
        id_ = id;
        left_sensor_ = new RobotEnviromentSensorPanel(brick_images_, this,
                "Regel " + id_ + " Bedingung: Sensor links");
        right_sensor_ = new RobotEnviromentSensorPanel(brick_images_, this,
                "Regel " + id_ + " Bedingung: Sensor rechts");
        ahead_sensor_ = new RobotEnviromentSensorPanel(brick_images_, this,
                "Regel " + id_ + " Bedingung: Sensor vorne");
        bottom_sensor_ = new RobotBottomSensorPanel(brick_images_, mark_array,
                this, "Regel " + id_ + " Bedingung: Boden Sensor");
        state_panel_ = new RobotStatePanel(brick_images_, state_array, false,
                this, "Regel " + id_ + " Bedingung: Roboterstatus");

        initComponents();
    }

    public ConditionPanel(HashMap brick_images, IntStringMap mark_array,
            IntStringMap state_array, Condition condition,
            RulePanel parent_panel, int id) {
        super();
        brick_images_ = brick_images;
        parent_panel_ = parent_panel;
        id_ = id;
        ...
        left_sensor_ = new RobotEnviromentSensorPanel(brick_images_, tmp, this,
                "Regel " + id_ + " Bedingung: Sensor links");
        ...
        right_sensor_ = new RobotEnviromentSensorPanel(brick_images_, tmp,
                this, "Regel " + id_ + " Bedingung: Sensor rechts");
        if (condition.isWallAhead() == true)
            tmp = RobotEnviromentSensorPanel.WALL;
        else
            tmp = RobotEnviromentSensorPanel.FREE;
        ahead_sensor_ = new RobotEnviromentSensorPanel(brick_images_, tmp,
                this, "Regel " + id_ + " Bedingung: Sensor vorne");
        bottom_sensor_ = new RobotBottomSensorPanel(brick_images_,
                condition.getCellMark() + 1, mark_array, this, "Regel " + id_
                        + " Bedingung: Boden Sensor");
        state_panel_ = new RobotStatePanel(brick_images_,
                condition.getState() + 1, state_array, false, this, "Regel "
                        + id_ + " Bedingung: Roboterstatus");
        initComponents();
    }
    ...
    public Condition getCondition() {
        ...
        Condition ret_condition = new Condition(
                state_panel_.getInternalState() - 1,
                bottom_sensor_.getInternalState() - 1, left_sensor_bool,
                right_sensor_bool, ahead_sensor_bool);
