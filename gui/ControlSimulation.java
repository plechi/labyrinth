...
public class ControlSimulation {
    ...
    public ControlSimulation(MenueExercisePanel menue_panel,
    ...
    public ControlSimulation(MenueExamPanel menue_panel,
            LevelHandler level_handler, IntStringMap mark_array,
            TUGLabyrinth laby) {
        laby_ = laby;
        level_handler_ = level_handler;
    ...
    public ControlSimulation(MenuePanel menue_panel,
            LevelHandler level_handler, IntStringMap mark_array) {
    ...
    public void addLabXpert(int level) {
        ...
        LabyrinthXpertFrame labyrinth_xpert_frame = new LabyrinthXpertFrame(
                current, this);
    ...
    public void printHelp() {
        ...
        try {
            ...
            // context_.showDocument(new URL("http://", code_base_.toString(),
            // "HelpWindow/inhalt.html"), "_blank");
            SqlCommunicator.add_log("Hilfe aufgerufen", 16);
            TUGInformations.getAppletContext().showDocument(
                    new URL(TUGInformations.getCodeBase(),
                            "HelpWindow/index.php"), "_blank");
