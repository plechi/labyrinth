...
public class LabSymbols {
    public final static String STARTSYMBOL = "S";
    public final static String WALLSYMBOL = "W";
    public final static String WAYSYMBOL = ".";
    public final static String DIAMONDSYMBOL = "D";
    public final static String EMPTYSYMBOL = "?";
}