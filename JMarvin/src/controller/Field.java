...
public class Field {
     ...
     */
    public Field(int rows, int cols) throws IllegalArgumentException {
        if ((rows < 0) || (cols < 0))
     ...
     * 
     * @param row
     *            the row of the desired element
     * @param col
     *            the column of the desired element
     * @exception IndexOutOfBoundsException
     *                thrown if the index is outside of the allocated range
     */
    ...
    public String toString() {
        ...
        return ("rows: " + field_.length + ", cols: " + field_[0].length);
    }
