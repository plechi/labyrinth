...
public class Robot {
     ...
     * 
     * @return info about the way the robot has taken when it returns false the
     *         robot wasn't on this cell before
     */
    public int getState() {
        return state_;
    }
    ...
    // -----------------------------------------------------------------------------
    /**
     * method to move a robot one cell forward (relative to his current
     * direction)
     * 
     * @exception IllegalDirectionException
     *                thrown if the direction isn't valid.
     */
    public void moveForward() throws IllegalDirectionException {
     ...
     *                thrown if the direction isn't valid.
     */
    public void goBack() throws IllegalDirectionException {
        saveCurrentDirection();
     ...
     *                thrown if the direction isn't valid.
     */
    public void goLeft() throws IllegalDirectionException {
        saveCurrentDirection();
     ...
     *                thrown if the direction isn't valid.
     */
    public void goRight() throws IllegalDirectionException {
        saveCurrentDirection();
        switch (current_direction_.getDirection()) {
        case Direction.DIRECTION_UP:
            current_direction_.setDirection(Direction.DIRECTION_RIGHT);
