...
public class TUGLabyrinth extends JFrame {
    ...
    public TUGLabyrinth() {
        try {
            ...
            URL url = TUGLabyrinth.class.getResource("/data");

            System.out.println("LOG:document base:" + url);
    ...
    public final void init() {
      ...
      /*
        ...
        if (abs_filename == null) {
            abs_filename = (getDocumentBase() != null ? getDocumentBase().getFile() : "") + "/data/config/games/Game.xml";
