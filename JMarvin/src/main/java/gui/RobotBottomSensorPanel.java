...
public class RobotBottomSensorPanel extends JPanel {
    ...
    public RobotBottomSensorPanel(HashMap brick_images,
            IntStringMap mark_array, UpdateObject parent_panel) {
        super();
    ...
    public RobotBottomSensorPanel(HashMap brick_images,
            IntStringMap mark_array, UpdateObject parent_panel, String name) {
        super();
        mark_array_ = mark_array;
        brick_images_ = brick_images;
        parent_panel_ = parent_panel;
    ...
    public RobotBottomSensorPanel(HashMap brick_images, int init_state,
            IntStringMap mark_array, UpdateObject parent_panel) {
        super();
        mark_array_ = mark_array;
        brick_images_ = brick_images;
    ...
    private void paintState() {
        ...
        case FLOOR_0:
            ...
            this.setToolTipText("Markierung: "
                    + mark_array_.getFromInt(internal_state_ - 1));
            break;
        case FLOOR_1:
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                if (name_ != null) {
                    SqlCommunicator.add_log(name_ + " geändert zu "
                            + mark_array_.getFromInt(internal_state_ - 1), 512);
                } else {
