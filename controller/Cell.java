...
public class Cell {
     ...
     *                thrown if the cell is allready a wall, the cell contains a
     *                diamond or a robot.
     */
    public void convertToWall() throws IllegalStateException {
        if ((status_ & WALL) != 0)
     ...
     * 
     * @exception IllegalStateException
     *                thrown if the cell is allready a way.
     */

    public void convertToWay() throws IllegalStateException {
        if ((status_ & WAY) != 0)
            throw (new IllegalStateException(
     ...
     * 
     * @exception IllegalStateException
     *                thrown if the cell is allready a startpoint.
     */
    public void convertToStartpoint() throws IllegalStateException {
     ...
     * 
     * @exception IllegalStateException
     *                thrown when trying to remove a startpoint form a cell that
     *                doesn't contain a startpoint
     */
    public void removeStartpoint() throws IllegalStateException {
        if ((status_ & STARTPOINT) == 0)
            throw (new IllegalStateException(
     ...
     * 
     * @exception IllegalStateException
     *                thrown when trying to place a diamond in a cell that
     *                already contains a diamond
     */
    public void setDiamond() throws IllegalStateException {
        if ((status_ & CONTAINS_DIAMOND) != 0)
            throw (new IllegalStateException(
     ...
     * 
     * @exception IllegalStateException
     *                thrown when trying to remove a diamond form a cell that
     *                doesn't contain a diamond
     */
    public void removeDiamond() throws IllegalStateException {
        if ((status_ & CONTAINS_DIAMOND) == 0)
            throw (new IllegalStateException(
     ...
     * 
     * @exception IllegalStateException
     *                thrown when trying to remove the visited state form a cell
     *                that isn't markt as visited
     */
    public void removeVisitedState() throws IllegalStateException {
     ...
     * 
     * @exception IllegalStateException
     *                thrown when trying to set the visited state in a cell that
     *                is already visited
     */
    public void setVisitedState() throws IllegalStateException {
        if ((status_ & VISITED) != 0)
            throw (new IllegalStateException(
     ...
     * 
     * @exception IllegalStateException
     *                thrown when trying to set the empty state in a cell that
     *                is already empty
     */
    public void setEmpty() throws IllegalStateException {
        if (status_ == EMPTY)
            throw (new IllegalStateException("can't set an empty cell"));
        status_ = EMPTY;
    }
