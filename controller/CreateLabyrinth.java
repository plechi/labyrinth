...
public class CreateLabyrinth {
    ...
    /**
     * allow or denay building a place There is no way to build a palce in the
     * Labyrinth wirhout to allow to build a loop
     */
     ...
     *            LabyrinthField for modification
     */
    ...
    public CreateLabyrinth(LabyrinthField labyrinth_field) {
        ...
        if (labyrinth_field_.isStartpoint() == false) {
            ...
            try {
                ...
                way_direction_.setDirection(labyrinth_field_
                        .getStartDirection().getDirection());
            ...
            new_point_ = false;
        } else if (labyrinth_field_.getNumWayCells() == 1
                && labyrinth_field_.isStartpoint() == true) {
            try {
                way_direction_ = new Direction();
                way_direction_.setDirection(labyrinth_field_
                        .getStartDirection().getDirection());
    ...
    // ------------------------------------------------------------------------------
    /**
     * method called from the outside to set the number of diamonds distributed
     * in this labyrinthfield. It is not checked, whether this number exceeds
     * the maximum allowed number. This has to be done beforehand.
     * 
     * @exception IllegalArgumentException
     *                thrown if the number of mines is < 0
     */

    public void setNumDiamonds(int num_diamonds)
            throws IllegalArgumentException {
        if (num_diamonds < 0)
            throw (new IllegalArgumentException("\"<" + TagName.DIAMONDS
                    + ">\"" + "must be >= 0"));
    ...
    // ------------------------------------------------------------------------------
    /**
     * method called from the outside to set the number of way cells distributed
     * in this labyrinthfield. It is not checked, whether this number exceeds
     * the maximum allowed number. This has to be done beforehand.
     * 
     * @exception IllegalArgumentException
     *                thrown if the number of way cells is < 0
     */

    public void setNumWayCells(int num_way_cells)
            throws IllegalArgumentException {
        if (num_way_cells < 0)
            throw (new IllegalArgumentException("\"<" + TagName.WAYCELLS
                    + ">\"" + "must be >= 0"));
     ...
     * @exception IllegalArgumentException
     *                thrown if min_way_lenght < 0
     */
    public void setMinWayLenght(int min_way_lenght)
            throws IllegalArgumentException {
        if (min_way_lenght < 0)
            throw (new IllegalArgumentException("\"<" + TagName.MINWAYLENGHT
                    + ">\"" + "must be >= 0"));
     ...
     * @exception IllegalArgumentException
     *                thrown if max_way_lenght < 0
     */
    public void setMaxWayLenght(int max_way_lenght)
            throws IllegalArgumentException {
        if (max_way_lenght <= 0)
            throw (new IllegalArgumentException("\"<" + TagName.MAXWAYLENGHT
                    + ">\"" + "must be > 0"));
     ...
     * @param build_angle
     * @exception IllegalArgumentException
     *                thrown if build_angle < 0
     */
    public void setBuildAngles(int build_angle) throws IllegalArgumentException {
        if (build_angle < 0)
            throw (new IllegalArgumentException("\"<" + TagName.BUILDANGLES
                    + ">\"" + "must be >= 0"));
     ...
     * @param build_tree
     * @exception IllegalArgumentException
     *                thrown if build_tree < 0
     */
    public void setBuildTrees(int build_tree) throws IllegalArgumentException {
        if (build_tree < 0)
            throw (new IllegalArgumentException("\"<" + TagName.BUILDTREES
                    + ">\"" + "must be >= 0"));
    ...
    /**
     * max number of places for the labyrinth there is no way to build a place
     * without to allow to build loops
     * 
     * @param build_place
     * @exception IllegalArgumentException
     *                thrown if build_place < 0
     */
    public void setBuildPlaces(int build_place) throws IllegalArgumentException {
        if (build_place < 0)
            throw (new IllegalArgumentException("\"<" + TagName.BUILDPLACES
                    + ">\"" + "must be >= 0"));
     ...
     * @param build_loop
     * @exception IllegalArgumentException
     *                thrown if build_loop < 0
     */
    public void setBuildLoops(int build_loop) throws IllegalArgumentException {
        if (build_loop < 0)
            throw (new IllegalArgumentException("\"<" + TagName.BUILDLOOPS
                    + ">\"" + "must be >= 0"));
     ...
     * 
     * @param min
     *            min value of the random value
     * @param max
     *            max value of the random value
     * @exception IllegalArgumentException
     *                thrown if min > max
     */
    ...
    public void calculateWays() {
        ...
        while (labyrinth_field_.getNumWayCells() < num_way_cells_
                && loops_ < max_loops_) {
     ...
     */
    private void buildWay() throws IllegalArgumentException {
        if (way_lenght_ == -1)
            throw (new IllegalArgumentException("way_lenght_ not set"));

        if (row_ == -1)
            throw (new IllegalArgumentException("row_ not set"));
        if (col_ == -1)
            throw (new IllegalArgumentException("col_ not set"));

        boolean conditions_array[][] = { { true, false },// way_direction_=1 to
                                                         // the top
        ...
        try {
            for (int way_lenght_counter = way_lenght_; way_lenght_counter > 0; way_lenght_counter--) {
                ...
                case Direction.DIRECTION_RIGHT:
                    way_direction_index = 1;
                    break;
                case Direction.DIRECTION_DOWN:
                    way_direction_index = 2;
                    break;
                case Direction.DIRECTION_LEFT:
                    way_direction_index = 3;
                    break;
                default:
                    way_direction_index = 0;
                }
     ...
     * 
     * @param row
     *            row coordinate of the cell to be convertet to a way
     * @param col
     *            col coordinate of the cell to be convertet to a way
     * @param row2
     *            row coordinate of the next cell that will be convertet to a
     *            way to check if ther will be closed a loop or build a place
     * @param col2
     *            col coordinate of the next cell that will be convertet to a
     *            way to check if ther will be closed a loop or build a place
     */
    ...
    public void setDiamonds() {
        ...
        while (labyrinth_field_.getNumDiamonds() < num_diamonds_
                && labyrinth_field_.getNumDiamonds() < (labyrinth_field_
                        .getNumWayCells() - 1)) {
            if (randomwaycoordinates_
                    .findRandomWayCoordinates(labyrinth_field_) == true) {
                row = randomwaycoordinates_.getRandomWayRowCoordinate();
                col = randomwaycoordinates_.getRandomWayColCoordinate();

                if (labyrinth_field_.containsDiamond(row, col) == false
                        && labyrinth_field_.isWay(row, col) == true
                        && labyrinth_field_.isStartpoint(row, col) == false) {
    ...
    public String toString() {
        return ("CreateLabyrinth: num_diamonds_ = " + num_diamonds_
                + ", num_way_cells_ = " + num_way_cells_ + ", build_angle_ = "
                + build_angle_ + ", build_tree_ = " + build_tree_
                + ", build_loop_ = " + build_loop_ + ", build_places_ = "
                + build_places_ + ", min_way_lenght_ = " + min_way_lenght_
                + ", max_way_lenght_ = " + max_way_lenght_ + super.toString());
    }
