...
/**
 * class represting a List of instructions which are excecuted by the turing
 * machine.
 */
...
public class InstructionList extends ArrayList<Instruction> {
    ...
    // -----------------------------------------------------------------------------
    /**
     * method adds an instruction at the specified position to the instruction
     * list.
     * 
     * @param index
     *            zero based position of the element to add.
     * @param instruction
     *            instruction to insert
     */
    ...
    // -----------------------------------------------------------------------------
    /**
     * method gets an instruction at the specified position in the instruction
     * list.
     * 
     * @param index
     *            zero based position of the requested instruction.
     * @return instruction
     */
    ...
    // -----------------------------------------------------------------------------
    /**
     * method replaces the instruction at the specified position in this list
