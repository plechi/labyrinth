...
/**
 * class provides methods for generating a labyrinth XML file for the tag names
 * and the labyrinth symbols the classes TagName and LabSymbols are used
 */
...
public class WriteLabToXML {
     ...
     *                if out.write throws an Exception
     */
    protected void writeWidth(OutputStreamWriter out) throws IOException {
     ...
     *                if out.write throws an Exception
     */
    protected void writeHeight(OutputStreamWriter out) throws IOException {
    ...
    // ------------------------------------------------------------------------------
    /**
     * method writes the dimension-element and all elements it contains to the
     * specified stream
     * 
     * @param out
     *            stream to use for writing
     ...
     *                if out.write throws an Exception
     */
    protected void writeDimension(OutputStreamWriter out) throws IOException {
    ...
    protected void writeName(OutputStreamWriter out) throws IOException {
    ...
    protected void writeStartDirection(OutputStreamWriter out)
            throws IOException {
        out.write(toStartTagString(TagName.STARTDIRECTION)
    ...
    // ------------------------------------------------------------------------------
    /**
     * method writes the labyrinth-element with the ASCII representation of the
     * labyrinth field to the specified stream
     * 
     * @param out
     *            stream to use for writing
     * @exception IOException
     ...
     *                thrown
     */
    protected void writeLabyrinth(OutputStreamWriter out) throws IOException {
        try {
    ...
    // ------------------------------------------------------------------------------
    /**
     * method writes the robotlabyrinth-element and all elements it contains to
     ...
     *                if out.write throws an Exception
     */
    public void writeRobotLabyrinth(OutputStreamWriter out) throws IOException {
    ...
    // ------------------------------------------------------------------------------
    /**
     * method creates a XML file with the given filename and writes the header
     * and the whole labyrinth data in this file
     * 
     * @param file_name
