...
public class IntStringMap {
    ...
    // ----------------------------------------------------------------------------
    /**
     * Standard constructor Initializes a new Array List
     */
    public IntStringMap() {
     ...
     *                thrown when trying to set a wrong value
     */
    public String getFromInt(int value) throws IndexOutOfBoundsException {
        if (value == -1)
            return "";
     ...
     * 
     * @param string
     * @return -1, if the string length was null, else the int representation of
     *         the string
     */
